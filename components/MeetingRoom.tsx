...
import { LayoutList, Loader, UsersIcon} from 'lucide-react'
  ...
  return (
    <section className='relative h-screen w-full overflow-hidden pt-4 text-white'>
      <div className="relative flex size-full justify-center items-center">
        ...
        <div className={cn('h-[calc(100vh-86px)] hidden ml-2', {'show-block': showParticipantsBar})}>
      ...
      <CallStatsButton/>
      <button onClick={() => setShowParticipantsBar(!showParticipantsBar)}>
